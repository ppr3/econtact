...
@section('htmlheader_title')
	{{ trans('app.reportmenu_mouth_export_admin')}}
@endsection
...
@section('main-content')
  ...
  {!! Form::open(array('route' => array('report.mouth.admin1'), 'class' => 'form-horizontal')) !!}
              
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">{{ trans('tracking.division_name') }}</label>
                  <div class="col-sm-4">
                    {!! Form::select('division_id',$division,$division_id,array('class' => 'form-control')) !!}                         
                  </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-xs-12">
                  <a href="{{ route('report.mouth.admin1') }}"  class="pull-right btn btn-warning"><i class="fa fa-undo fa-lg"></i>  @lang('commander.btn_cancle')</a>
                  <a href="{{ URL::to('report/export',[$division_id,($year_st.$mount_st.$day_st),($year_en.$mount_en.$day_en)])}}"  class="pull-right btn btn-success" style="margin-right: 5px;"><i class="fa fa-file-excel-o fa-lg"></i> Export to Excel</a>
