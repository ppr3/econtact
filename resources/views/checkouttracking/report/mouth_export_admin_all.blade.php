...
@section('htmlheader_title')
	{{ trans('app.reportmenu_mouth_export_admin_all')}}
@endsection
...
@section('main-content')
  ...
  {!! Form::open(array('route' => array('report.mouth.admin2'), 'class' => 'form-horizontal')) !!}
            ...
            <div class="row">
                <div class="col-lg-12 col-xs-12">
                  <a href="{{ route('report.mouth.admin2') }}"  class="pull-right btn btn-warning"><i class="fa fa-undo fa-lg"></i>  @lang('commander.btn_cancle')</a>
                  <a href="{{ URL::to('report/exportadmin',[(date('Y').$mount_st.$day_st),(date('Y').$mount_en.$day_en)])}}"  class="pull-right btn btn-success" style="margin-right: 5px;"><i class="fa fa-file-excel-o fa-lg"></i> Export to Excel</a>
              ...
              <div class="box-body">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="col-lg-3">@lang('commander.fname')</th>
                                <th class="col-lg-3">@lang('commander.lname')</th>
                                <th class="col-lg-3">@lang('commander.division_name')</th>
                                <th class="col-lg-1">@lang('commander.position_name')</th>
                                <th class="col-lg-1">@lang('commander.numof_tracking')</th>
                            </tr>
                        </thead>
                        <tbody>
